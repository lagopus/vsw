...
static inline uint32_t
hash_fnv1a32(uint32_t input) {
  return hash_fnv1a32_internal(&input, sizeof(uint32_t));
}

static inline uint32_t
hash_fnv1a32_with_size(void *input, size_t size) {
  return hash_fnv1a32_internal(input, size);
}
